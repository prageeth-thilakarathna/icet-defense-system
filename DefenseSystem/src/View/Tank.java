 ...
 * @author ygpra
 */
public class Tank extends JFrame implements DefenseObserver {
    
    CentralController observable = CentralController.getInstance();
    
    private final JPanel tankClearance;
    ...
    private final JPanel tankUpdates;
    private final JButton btnShoot;
    private final JButton btnRedar;
    private final JButton btnCannon;
    private final JButton btnBallistic;
    ...
    public Tank() {
        ...
        // tank Clearance
        tankClearance = new JPanel();
        tankClearance.setBackground(whiteBack);
        tankClearance.setLayout(new BorderLayout());

        // area header panel
        areaHeader = new JPanel();
        areaHeader.setLayout(new BorderLayout());
        areaHeader.setBackground(MainColor);
        tankClearance.add(areaHeader, BorderLayout.NORTH);
        ...
        tankClearance.add(areaCondition, BorderLayout.WEST);
        ...
        tankClearance.add(checkPanel, BorderLayout.SOUTH);
        ...
        checkBox.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if(levelValue>=ControllerUtilities.strengthLevels.LOW.getValue() && levelValue<ControllerUtilities.strengthLevels.MEDIUM.getValue()){
                   observable.enableGun(ControllerUtilities.strengthLevels.LOW.getValue()); 
                } else if(levelValue>=ControllerUtilities.strengthLevels.MEDIUM.getValue() && levelValue<ControllerUtilities.strengthLevels.HIGH.getValue()){
                   observable.enableGun(ControllerUtilities.strengthLevels.MEDIUM.getValue()); 
                } else if(levelValue>=ControllerUtilities.strengthLevels.HIGH.getValue() && levelValue<ControllerUtilities.strengthLevels.STRONG.getValue()){
                   observable.enableGun(ControllerUtilities.strengthLevels.HIGH.getValue()); 
                } else if(levelValue>=ControllerUtilities.strengthLevels.STRONG.getValue() && levelValue<ControllerUtilities.strengthLevels.CLOSED.getValue()){
                   observable.enableGun(ControllerUtilities.strengthLevels.STRONG.getValue()); 
                } else if(levelValue==ControllerUtilities.strengthLevels.CLOSED.getValue()){
                   observable.enableGun(ControllerUtilities.strengthLevels.CLOSED.getValue());
                } else{
        ...
        // redar
        btnRedar = new JButton("Redar");
        btnRedar.setBounds(185, 25, 130, 35);
        btnRedar.setFont(new Font("", 1, 16));
        btnRedar.setBackground(OverMain);
        btnRedar.setForeground(Color.white);
        btnRedar.setBorderPainted(false);
        btnRedar.setFocusPainted(false);
        btnRedar.setEnabled(false);
        gunsPanel.add(btnRedar);

        // cannon
        btnCannon = new JButton("Cannon");
        btnCannon.setBounds(23, 85, 130, 35);
        btnCannon.setFont(new Font("", 1, 16));
        btnCannon.setBackground(OverMain);
        btnCannon.setForeground(Color.white);
        btnCannon.setBorderPainted(false);
        btnCannon.setFocusPainted(false);
        btnCannon.setEnabled(false);
        gunsPanel.add(btnCannon);
        ...
        btnSend.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent evt) {
                observable.addMessage(new UnitDetails(0, "Tank", sendMessageBox.getText()));
        ...
        // tank updates
        tankUpdates = new JPanel();
        tankUpdates.setLayout(new BorderLayout());
        
        // update head panel
        updateHeadPanel=new JPanel();
        updateHeadPanel.setLayout(new BorderLayout());
        updateHeadPanel.setBackground(MainColor);
        tankUpdates.add(updateHeadPanel, BorderLayout.NORTH);
        
        // update header
        updateHeader=new JLabel("Tank Updates", SwingConstants.CENTER);
        ...
        tankUpdates.add(updateBody, BorderLayout.CENTER);
        ...
        soldierCount.addChangeListener(new ChangeListener(){
            ...
            public void stateChanged(ChangeEvent evt){
                ...
                mainController.addUnitInfoMain("Tank", "Soldier", data);
            }
        });
        ...
        ammoCount.addChangeListener(new ChangeListener(){
            ...
            public void stateChanged(ChangeEvent evt){
                ...
                mainController.addUnitInfoMain("Tank", "Ammo", data);
            }
        });
    ...
    public void gunsEnable(int index) {
        if (index == ControllerUtilities.strengthLevels.LOW.getValue() & (positionCheck % 2 != 0)) {
            btnShoot.setEnabled(true);
            btnShootHover(true);
            btnRedar.setEnabled(false);
            btnRedarHover(false);
            btnCannon.setEnabled(false);
            btnCannonHover(false);
            btnBallistic.setEnabled(false);
            btnBallisticHover(false);
        } else if (index == ControllerUtilities.strengthLevels.MEDIUM.getValue() & (positionCheck % 2 != 0)) {
            btnShoot.setEnabled(true);
            btnShootHover(true);
            ...
            btnBallistic.setEnabled(false);
            btnBallisticHover(false);
        } else if (index == ControllerUtilities.strengthLevels.HIGH.getValue() & (positionCheck % 2 != 0)) {
            btnShoot.setEnabled(true);
            btnShootHover(true);
            btnRedar.setEnabled(true);
            btnRedarHover(true);
            ...
            btnBallistic.setEnabled(false);
            btnBallisticHover(false);
        } else if ((index == ControllerUtilities.strengthLevels.STRONG.getValue() || index == ControllerUtilities.strengthLevels.CLOSED.getValue()) & (positionCheck % 2 != 0)) {
            btnShoot.setEnabled(true);
            btnShootHover(true);
            btnRedar.setEnabled(true);
            btnRedarHover(true);
    ...
    public void btnRedarHover(boolean condition) {
        if (condition) {
            btnRedar.setBackground(MainColor);
            btnRedar.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseEntered(MouseEvent me) {
                    btnRedar.setBackground(OverMain);
                    btnRedar.setCursor(new Cursor(Cursor.HAND_CURSOR));
                }
    ...
    public void btnCannonHover(boolean condition) {
        if (condition) {
            btnCannon.setBackground(MainColor);
            btnCannon.addMouseListener(new MouseAdapter() {
                @Override
                public void mouseEntered(MouseEvent me) {
                    btnCannon.setBackground(OverMain);
                    btnCannon.setCursor(new Cursor(Cursor.HAND_CURSOR));
                }
                ...
                @Override
                public void mousePressed(MouseEvent me) {
                    btnCannon.setForeground(Color.black);
                }
